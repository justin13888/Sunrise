...
* **The write bound belongs at the relay, and peer-side enforcement comes after it.** Refusing at apply time cannot be made convergent without a projection rebuild this engine does not have, and it is what would reintroduce order-dependent divergence. [#80](https://github.com/justin13888/Sunrise/issues/80) is the write bound; [#82](https://github.com/justin13888/Sunrise/issues/82) is defence in depth on top of it, not a substitute for it.
