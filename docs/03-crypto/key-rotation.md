...
[ADR-0055](../11-adr/0055-a-revocation-is-withdrawn-only-by-its-author.md) decides the inverse, and [#383](https://github.com/justin13888/Sunrise/issues/383) builds it:
...
The op waits for [#320](https://github.com/justin13888/Sunrise/issues/320). Until an unknown op kind is parked rather than dropped as corruption, an older build would never see a withdrawal, and the register would split between builds.
