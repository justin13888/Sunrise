...
- The test `a_revoked_devices_ops_still_apply_at_the_replica`
  (`crates/sunrise-core/src/engine/tests.rs:7428-7430#a_revoked_devices_ops_still_apply_at_the_replica`)
...
- **No code changes.** The test doc at
  `crates/sunrise-core/src/engine/tests.rs:7388#a_revoked_devices_ops_still_apply_at_the_replica`
