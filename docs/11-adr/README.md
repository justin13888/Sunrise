...
| 0055 | [A revocation is withdrawn only by the device that made it, and the withdrawal waits for unknown op kinds to be parked](./0055-a-revocation-is-withdrawn-only-by-its-author.md) | accepted, not yet built (amends 0041 §"What a user sees" item 4; depends on 0045 §4; built by #383) |
