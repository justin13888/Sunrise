...
export type RoutineCategoryDefinition = Static<
    typeof routineCategoryDefinitionSchema
>;
...
export const durationSchema = Type.Object({
    ...
    min_duration: Type.Optional(
        Type.Number({ minimum: 5, examples: [15, 30] }),
    ),
    /** Maximum duration if flexible */
    max_duration: Type.Optional(
        Type.Number({ maximum: 480, examples: [90, 180] }),
    ),
});
...
export const dependencySchema = Type.Object({
    ...
    buffer_minutes: Type.Optional(
        Type.Number({ minimum: 0, default: 0, examples: [5, 15, 30] }),
    ),
});
...
export const routineSchema = Type.Object({
    ...
    name: Type.String({
        minLength: 1,
        maxLength: 100,
        examples: ["Morning Exercise", "Deep Work Block"],
    }),
    /** Optional description */
    description: Type.Optional(
        Type.String({
            maxLength: 500,
            examples: ["Energizing physical activity to start the day"],
        }),
    ),
    ...
    time_preferences: Type.Array(timeOfDaySchema, {
        examples: [["morning", "late_morning"]],
    }),
    ...
    minimum_gap_minutes: Type.Number({
        minimum: 0,
        default: 0,
        examples: [0, 15, 30],
    }),
    ...
    preferred_batch_size: Type.Optional(
        Type.Number({ minimum: 1, maximum: 10, examples: [2, 3] }),
    ),
...
export const routineTemplateSchema = Type.Object({
    ...
    id: Type.String({
        examples: ["remote_worker_standard", "early_bird_focused"],
    }),
    /** Display name for the template */
    name: Type.String({
        examples: [
            "Remote Worker - Standard",
            "Early Bird - High Productivity",
        ],
    }),
    /** Description of what this template is for */
    description: Type.String({
        examples: [
            "Balanced routine for remote workers with flexible schedule",
        ],
    }),
    /** List of routines in this template */
    routines: Type.Array(routineSchema),
    /** Types of users this template is designed for */
    target_user_type: Type.Array(Type.String(), {
        examples: [["remote_worker", "early_bird"]],
    }),
});
...
export const manualOverrideSchema = Type.Object({
    ...
    routine_id: Type.String({
        examples: ["morning_exercise", "deep_work_block"],
    }),
    ...
    new_time: Type.Optional(
        Type.String({ examples: ["2025-05-28T09:00:00Z"] }),
    ),
    ...
    expires_at: Type.Optional(
        Type.String({ examples: ["2025-05-29T00:00:00Z"] }),
    ),
});
...
export const ROUTINE_TEMPLATES: RoutineTemplate[] = [
    {
        ...
        routines: PRECONFIGURED_ROUTINES.filter(
            (r) => !r.tags.includes("commute") && r.frequency !== "weekends",
        ),
    },
    {
        ...
        description:
            "Optimized for early risers who prefer morning productivity",
        target_user_type: ["early_bird", "morning_person", "high_productivity"],
        routines: PRECONFIGURED_ROUTINES.filter((r) =>
            r.time_preferences.some((t) =>
                ["early_morning", "morning"].includes(t),
            ),
        ),
    },
    {
        ...
        routines: PRECONFIGURED_ROUTINES.filter(
            (r) =>
                r.category === "6ba7b810-9dad-11d1-80b4-00c04fd430c8" ||
                r.tags.includes("fitness") ||
                r.priority === "high",
        ),
    },
];
