...
describe('DateTimeScalar', () => {
    ...
    describe('parseLiteral', () => {
        ...
        it('should throw error for non-string literals', () => {
            ...
            expect(() => DateTimeScalar.parseLiteral(intAst as any, {})).toThrow(
                'Value must be an ISO string literal'
            )
            ...
            expect(() => DateTimeScalar.parseLiteral(floatAst as any, {})).toThrow(
                'Value must be an ISO string literal'
            )
            ...
            expect(() => DateTimeScalar.parseLiteral(boolAst as any, {})).toThrow(
                'Value must be an ISO string literal'
            )
        })
