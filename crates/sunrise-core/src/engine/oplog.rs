...
/// `crates/sunrise-core/src/engine/tests.rs:8351#a_stranger_cert_through_apply_remote_is_refused_and_writes_no_cursor`.
///
...
/// `crates/sunrise-core/src/engine/tests.rs:7822#a_revoked_device_cert_through_apply_remote_seals_no_keys`
/// walks that trace from the envelope down to the early return, and
/// `crates/sunrise-core/src/engine/tests.rs:8082#a_failed_backfill_is_logged_and_the_cert_delivery_still_applies`
...
/// it writes lands.
/// `crates/sunrise-core/src/engine/tests.rs:7419#a_revoked_devices_ops_still_apply_at_the_replica`
...
/// `crates/sunrise-core/src/engine/tests.rs:8218#a_failed_local_emit_leaves_the_cursor_where_it_was`
...
/// why
/// `crates/sunrise-core/src/engine/tests.rs:7508#a_self_refused_revoke_still_advances_the_cursor`
...
/// `crates/sunrise-core/src/engine/tests.rs:7679#a_read_bounded_senders_recipient_claim_is_refused_and_the_cursor_counts_the_op`
...
/// `crates/sunrise-core/src/engine/tests.rs:8460#a_refold_that_unwinds_a_revocation_moves_no_cursor`
...
/// `crates/sunrise-core/src/engine/tests.rs:7963#a_self_refused_revoke_out_of_order_leaves_the_cursor_short`
/// pins.
